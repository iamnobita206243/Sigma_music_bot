...
REPO_VIDEO = "https://files.catbox.moe/qpnoky.mp4"
...
async def send_repo(_, message: Message):
    await message.reply_video(
        ...
        caption=(
            ...
            "🧡 ᴄʀᴇᴅɪᴛꜱ : <a href='https://t.me/NOBITA_SUPP0RT'>˹ 𝐍ᴏʙɪᴛᴀ ꭙ 𝐒ᴜᴘᴘᴏʀᴛ ˼</a>"
        ),
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("📂 Update Channel", url="https://t.me/NOBITA_SUPP0RT"),
                    InlineKeyboardButton("📂 Music Bot", url="https://github.com/iamnobita09/NOBITA_MUSIC")
                ]
            ]
        ),
        supports_streaming=True,
